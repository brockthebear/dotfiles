# Generated by Powerlevel10k configuration wizard on 2022-08-04 at 15:30 CDT.
...
# 2 lines, dotted, dark-ornaments, sparse, fluent, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    local      clean='%F{5} + %F{5}' # blue/red foreground
    local   modified='%F{93} ! %F{93}' # blue/red foreground
    local  untracked='%F{166} ? %F{166}' # blue/red foreground
    local conflicted='{%9F} ⇕ {%9F}' # red foreground
